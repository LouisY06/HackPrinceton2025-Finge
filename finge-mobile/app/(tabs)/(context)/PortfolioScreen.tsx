...
const styles = StyleSheet.create({
  ...
  portfolioHeader: { backgroundColor: '#F0F0F0', padding: 20, margin: 16, borderRadius: 16, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2, elevation: 2 },
  welcomeText: { fontSize: 22, fontWeight: '600', marginBottom: 4, color: '#333' },
  checkText: { fontSize: 16, color: '#555', marginBottom: 12 },
  readInsightsButton: { alignSelf: 'flex-start', backgroundColor: '#007AFF', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 20 },
  readInsightsButtonText: { color: '#fff', fontSize: 16, fontWeight: '500' },
  scrollableContainer: { flex: 1, marginHorizontal: 16, marginBottom: 16, backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden' },
  portfolioListContainer: { padding: 16, paddingBottom: 24 },
  portfolioTitle: { fontSize: 20, fontWeight: '600', marginBottom: 12, color: '#333' },
  portfolioItem: { flexDirection: 'row', backgroundColor: '#fff', marginBottom: 12, padding: 16, borderRadius: 16, alignItems: 'center' },
  ...
  swipeAction: { backgroundColor: '#4CAF50', justifyContent: 'center', alignItems: 'center', width: 80, borderTopRightRadius: 16, borderBottomRightRadius: 16 },
